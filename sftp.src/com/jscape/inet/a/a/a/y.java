...
import com.jscape.inet.a.a.b.fb;
  ...
  extends a
{
    ...
    throws IOException
  {
    ...
    return new fb(str1, str2);
  }
  
  public void a(com.jscape.inet.a.a.b.o paramo, OutputStream paramOutputStream)
    throws IOException
  {
    fb localfb = (fb)paramo;
    com.jscape.util.g.a.o.a(localfb.b, z, paramOutputStream);
    com.jscape.util.g.a.o.a(localfb.c, z, paramOutputStream);
  }
 ...
 * Qualified Name:     com.jscape.inet.a.a.a.y

...
class Scp$DownloadDirectoryListener
  implements OperationListener
{
  private hc a;
  final Scp b;
  
  private Scp$DownloadDirectoryListener(Scp paramScp) {}
  ...
  {
    Scp.a(this.b, new ScpTransferProgressEvent(this.b, paramFile.getName(), paramLong1, paramLong2, 1));
  }
  ...
  Scp$DownloadDirectoryListener(Scp paramScp, Scp.1 param1)
  {
    this(paramScp);
  }
}
 ...
 * Qualified Name:     com.jscape.inet.scp.Scp.DownloadDirectoryListener

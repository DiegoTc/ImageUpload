  ...
  implements Dispatchable
{
    ...
    throws IOException
  {
    ...
    return new SshFxpOpendir(l, SshString.readValue(paramInputStream, paramString));
  }
  
  private SshFxpOpendir(long paramLong, String paramString)
  {
    this(paramString);
    setId(paramLong);
  }
  
  public SshFxpOpendir(String paramString)
  {
    super(11);
    u.a(paramString);
    this.d = paramString;
    ...
    throws IOException
  {
    ...
    return paramPacketDispatcher.onSshFxpOpendir(this);
  }
 ...
 * Qualified Name:     com.jscape.inet.sftp.packets.SshFxpOpendir
